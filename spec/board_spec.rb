...
RSpec.describe 'Board Class' do
  ...
  describe 'empty board' do
    it 'prints row 1' do
      expect(test_board.row_1).to eq(expected_row_1)
    end
    it 'prints row divider 1' do
      expect(test_board.row_div_1).to eq(expected_row_div_1)
    end
    it 'prints row 2' do 
      expect(test_board.row_2).to eq(expected_row_2)
    end
    it 'prints row divider 2' do 
      expect(test_board.row_div_2).to eq(expected_row_div_2)
    end
    it 'prints row 3' do
      expect(test_board.row_3).to eq(expected_row_3)
    end
  end
end